# WealthSensePro-ESG - Frontend Application

## 📋 Vue d'ensemble

WealthSensePro-ESG est une solution de gestion de patrimoine dédiée aux utilisateurs finaux (particuliers), axée sur la thématique ESG (Environnement, Social, Gouvernance). Cette plateforme utilise l'intelligence artificielle pour fournir des conseils financiers personnalisés et des outils adaptés à la prise en compte des critères ESG dans la gestion de patrimoine.

Le frontend est une application **React.js** moderne construite avec **TypeScript**, utilisant **Vite** comme bundler et **Tailwind CSS** pour le styling. L'application intègre un système d'authentification hybride sécurisé et une interface utilisateur intuitive pour la gestion patrimoniale ESG.

## 🏗️ Architecture globale de l'application

```
WealthSensePro-ESG/
├── frontend/                    # Application React.js (ce répertoire)
│   ├── src/
...
- **React Router DOM 6.21.1** - Routage côté client

### Styling et UI
- **Tailwind CSS 3.4.0** - Framework CSS utilitaire
- **Framer Motion 12.10.5** - Animations et transitions
- **Lucide React 0.303.0** - Icônes modernes et cohérentes
- **React Intersection Observer 9.16.0** - Animations au scroll

### Charts et Visualisation
- **Chart.js 4.4.1** - Bibliothèque de graphiques
- **React Chart.js 2 5.2.0** - Wrapper React pour Chart.js

### HTTP et Communication
- **Axios 1.6.2** - Client HTTP avec intercepteurs
- **Firebase 10.7.1** - SDK client pour l'authentification

### Développement
- **ESLint 8.55.0** - Linting et qualité du code
- **PostCSS 8.4.32** - Post-processing CSS
